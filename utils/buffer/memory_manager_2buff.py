...
class memory_manager_class_2buff(object):
    ...
    def retrieve_from_main(self,batch_x,batch_y,retrieve_num = None):
        mem_x, mem_y = self.buffer.retrieve(x=batch_x, y=batch_y,retrieve_num = retrieve_num)

        return mem_x, mem_y

    def retrieve_from_add(self,batch_x,batch_y,retrieve_num = None):
        mem_x, mem_y = self.buffer_add.retrieve(x=batch_x, y=batch_y,retrieve_num=retrieve_num)
