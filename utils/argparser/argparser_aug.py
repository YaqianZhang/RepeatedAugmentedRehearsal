...
def parse_aug(parser):
    ...
    parser.add_argument("--randaug",default=False,type=boolean_string)
    parser.add_argument("--deraug",default=False,type=boolean_string)
    parser.add_argument("--aug_normal",default=False,type=boolean_string)
    ...
    parser.add_argument("--scrview",default="scraug",choices=["None","randaug","scraug"])
